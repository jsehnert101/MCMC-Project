...
```{r}
print("The following code is my submission for the Final Capstone of STT 223 - Intro. to Bayesian Inference, taught my Professor Joesph Ciminelli during Spring 2019.")
```
